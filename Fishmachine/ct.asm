...
# VariableAssign BEGIN
    .STATVAR_0001:
    .String "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
# VariableAssign END
.globl print
print:
    PUSH_REG %ebp
